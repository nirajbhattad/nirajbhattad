...
- 🔭 Expertise in **Go, C#, C, C++, Java, Python, .NET Core and .NET Framework**.
...
- 🔭 Experience with **AWS services, Git, Docker, Kubernetes, Kafka, CI/CD and RabbitMQ**.
- 🔭 Skilled in **Agile, Scrum, Jira, Confluence, Kanban and Swagger**.
